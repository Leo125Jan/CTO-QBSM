...
class UAV():
	...
	def __init__(self):
		...
		self.imu_sub = rospy.Subscriber("/uav2/mavros/imu/data", Imu, self.imu_callback, queue_size = 20, buff_size = 52428800)
	...
	def Collect_Data(self):
		...
		# Neighbors States
		self.neighbors_fov = np.array([self.neighor_0_fov, self.neighor_1_fov])
		...
		self.neighbors_position = np.array([[self.P1[0], self.P1[1]], [self.P2[0], self.P2[1]]])
	...
	def	controller(self, dx, dp, step):
		...
		self.cmd_vel.linear.z = 0.5 - self.P3[2]
...
if __name__ == '__main__':
	...
	try:
		...
		ptz_3 = PTZcon(camera2, map_size, grid_size)
		uav_3 = UAV()

		while uav_3.b is None:
